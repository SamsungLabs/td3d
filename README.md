...
| S3DIS (5 area) <br /> (ScanNet pretrain) | 85.6 | 75.5 | 61.1 | [model](https://github.com/SamsungLabs/td3d/releases/download/v1.0.0/epoch_6.pth) &#124; [config](configs/td3d_is/td3d_is_s3dis-3d-5class.py) |
